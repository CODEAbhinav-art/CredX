...
export default function PassportPreview({ scoreData, personaName }: PassportPreviewProps) {
  if (!scoreData) {
    return (
  ...
  return (
    <div style={{ width: "100%", maxWidth: 440, display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 24, width: "100%", justifyContent: "flex-end" }}>
        <button className="btn btn-outline btn-sm" style={{ borderRadius: 99 }}>
        ...
        <div style={{ padding: "32px 24px", background: "#fff" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: 16, borderBottom: "1px dashed var(--border)" }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 700, color: "var(--text-primary)" }}>{scoreData.sub_scores.income_stability} / 100</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: 16, borderBottom: "1px dashed var(--border)" }}>
              <span style={{ fontSize: 14, color: "var(--text-secondary)" }}>Payment Reliability</span>
              <span style={{ fontSize: 15, fontWeight: 700, color: "var(--text-primary)" }}>{scoreData.sub_scores.payment_reliability} / 100</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: 8 }}>
              <span style={{ fontSize: 14, color: "var(--text-secondary)" }}>Transaction Behaviour</span>
              <span style={{ fontSize: 15, fontWeight: 700, color: "var(--text-primary)" }}>{scoreData.sub_scores.digital_behaviour} / 100</span>
            </div>
          </div>
        </div>
